...
print(non_noisy_simulator.simulate_expectation_values(in_circ, observables=[cirq.Z(q) for q in in_circ.all_qubits()]))
...
print(cirq.fidelity(result.final_density_matrix, result.final_density_matrix, qid_shape=(len(result.final_density_matrix),)))
...
print(cirq.fidelity(result.final_density_matrix, noisy_result.final_density_matrix, qid_shape=(len(result.final_density_matrix),)))
